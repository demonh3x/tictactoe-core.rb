...
RSpec.describe "Regression" do
  ...
  def player(mark, opponent, random)
    RandomStrategyPlayer.new(mark, PerfectPlayer.new(mark, opponent), random)
  end
  ...
  describe "properties", :properties => true, :slow => true, :very_slow => true, :eternal => true do
    ...
    100.times do |n|
      it 'two perfect players in a 3x3 board ends up in a draw' do
        ...
        expect(game_winner ThreeByThreeBoard.new, random).to eq(nil)
      end
    end
  end
  ...
  describe "regression", :regression => true, :slow => true, :very_slow => true do
    it '4x4 failure with depth 4' do
      ...
      expect(game_winner FourByFourBoard.new, RepeteableRandom.new(sequence)).to eq(nil)
    end
    ...
    it '3x3 failure with depth 4' do
      ...
      expect(game_winner ThreeByThreeBoard.new, RepeteableRandom.new(sequence)).to eq(nil)
    end
  end
end
